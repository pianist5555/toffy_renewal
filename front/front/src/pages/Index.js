...
import IPMS from "../images/IPMS.png"
  ...
  render() {
    return (
      <div className="Index">
        ...
        <div className="Want">
          <p className='LargeCategory'>저는 이런 것을 추구합니다.</p>
          <p>모든 인프라, 서버 트러블에 유연하게 대처하는 전문가를 향해 갑니다. </p> 
          <p>모른다는 말을 먼저 하기보다 내일은 이해하고 구현할 수 있다는 태도를 가지고 임하고 있습니다.</p> 
        ...
        <div className="Carrer">
          ...
          <p>제이카 (2020년 6월 ~ 2021년 10월) | 1년 5개월</p>
          <div className='Role'>
        ...
        <p className='LargeCategory'>사이드프로젝트</p>
          ...
          <div className="IPMS">
            <a href="../static/portfolio/IPMS.pdf"><img src={IPMS} alt="IPMS" width='80px' /></a><span>← Click!</span>
            <div className='introduction'>
